...
class ConvertFragmentAdapter(
    private val context: Context?,
    private val currencyList: List<GetBaseConvertResponse>,
    private val clickListeners: (position: Int) -> Unit
) : RecyclerView.Adapter<ConvertFragmentAdapter.CashConvertFragmentAdapterViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        inflater.inflate(R.layout.convert_item, parent, false)
    )
